            ...
            <form id="payment-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="amountPaidToday" name="amountPaidToday" type="number" min="0" required value={amountPaidToday} onChange={(e) => setAmountPaidToday(Number(e.target.value))} className="border-primary" />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input id="transactionId" name="transactionId" placeholder="e.g. UPI-123456789" />
                </div>

                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="paymentNotes">Payment Notes</Label>
                  <Textarea id="paymentNotes" name="paymentNotes" placeholder="Any remarks regarding this payment..." />
                </div>
              </div>
            </form>
          </CardContent>
